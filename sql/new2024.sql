...
ALTER TABLE `Factura`
  ADD CONSTRAINT `FK_ID_PEDIDO_FACTURA` FOREIGN KEY (`FK_ID_PEDIDO`) REFERENCES `Pedidos` (`id_ped`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `PEDIDO_INSUMO`
  ...
  ADD CONSTRAINT `FK_ID_PEDIDO_PEDIDO_INSUMO` FOREIGN KEY (`FK_ID_PEDIDO`) REFERENCES `Pedidos` (`ID_PED`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `PEDIDO_MATERIAPRIMA`
  ...
  ADD CONSTRAINT `FK_ID_PEDIDO_PEDIDO_MATERIAPRIMA` FOREIGN KEY (`FK_ID_PEDIDO`) REFERENCES `Pedidos` (`ID_PED`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- Cambio de restricciones para `PEDIDO_PROVEEDOR`
ALTER TABLE `PEDIDO_PROVEEDOR`
  ADD CONSTRAINT `FK_ID_PEDIDO_PEDIDO_PROVEEDOR` FOREIGN KEY (`FK_ID_PEDIDO`) REFERENCES `Pedidos` (`ID_PED`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
ALTER TABLE `Devolucion`
  ADD CONSTRAINT `FK_ID_PEDIDO_DEVOLUCION` FOREIGN KEY (`FK_ID_PEDIDO`) REFERENCES `Pedidos` (`ID_PED`) ON DELETE RESTRICT ON UPDATE CASCADE;
