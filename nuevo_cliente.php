            ...
            <form action="basededatos/agregarc2.php"  method="POST">
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="inputName">Numero de DNI</label>
                  <input type="number" class="form-control" id="inputName" name="dni" placeholder="" required="">
                </div> 
                <div class="form-group col-md-6">
                
                  <label for="inputPrice">Telefono</label>
                  <input type="number" name="telefono" class="form-control" id="inputrice" placeholder="" required="">
                </div>
              </div>
              <div class="form-row">
                <div class="form-group col-md-6">
                  <label for="inputCantidad">Nombre</label>
                  <input type="text" name="nombre" class="form-control" id="inputCantidad" placeholder="" required="">
                </div>
                <div class="form-group col-md-3">

                  <label for="inputCantidad">Primer Apellido</label>
                  <input type="text" name="apellido_1" class="form-control" id="inputCantidad" placeholder="" required="">
                </div>
                <div class="form-group col-md-3">

                  <label for="inputCantidad">Segundo Apellido</label>
                  <input type="text" name="apellido_2" class="form-control" id="inputCantidad" placeholder="" required="">
                </div>
              </div>
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="direccion" class="form-control" id="inputName" placeholder="" required="">
                  <div class="space-small"></div>
                  <label for="exampleFormControlTextarea1">Descripción</label>
                <textarea name="descripcion" class="form-control" id="exampleFormControlTextarea1" rows="7" required=""></textarea>
                <label for="inputName">Contraseña</label>
                  <input type="password" name="pass" class="form-control" id="inputName" placeholder="" required="">
                </div>
