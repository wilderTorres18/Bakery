                ...
                <form action="../basededatos/actuapd.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="text" value="<?php echo $Nom; ?>" class="form-control" name="nom" id="inputName" maxlength="200" onkeypress="return texto_1(event)" onpaste="return false" placeholder="">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="inputPrice">Precio</label>
                      <input type="text" value="<?php echo $pre; ?>" name="pre" class="form-control" id="inputPrice" placeholder="">
                    </div>
                  </div>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ¿Estás seguro de modificar este ítem?
                      </div>
